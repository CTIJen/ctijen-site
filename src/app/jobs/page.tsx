    ...
    return (
      <>
        <PageHero
          ...
          title="CTI"
          titleEm="Jobs"
          desc="Where to find CTI and cybersecurity roles. Don't forget — your network is your most powerful job search tool."
        />
        <GradientRule />
        <section style={{ padding: '80px 48px', background: 'var(--cream)' }}>
          <div style={{
            ...
            }}>A note on job titles</div>
            <p style={{ fontSize: '15px', color: 'rgba(250,247,242,0.7)', lineHeight: 1.8, fontWeight: 300 }}>
              CTI roles go by many names: Threat Intelligence Analyst, Cyber Threat Analyst, Intelligence Analyst,
              Threat Researcher, Detection Engineer, and more. Search broadly. Also search for roles at companies
              known for CTI work — Mandiant, CrowdStrike, Recorded Future, Red Canary, Team Cymru, and the major banks
              all have dedicated CTI teams.
            </p>
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', gap: '12px' }}>
            {boards.map((board, i) => (
              <ResourceCard key={i}>
                <a href={board.href} target="_blank" rel="noopener noreferrer" style={{
        ...
        <ClosingNote
          text="Want advice on breaking into CTI specifically? Reach out — happy to give more tailored guidance."
