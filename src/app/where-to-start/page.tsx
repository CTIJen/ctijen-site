'use client';
import { PageHero, GradientRule, SectionHeader, JenNote, ClosingNote } from '@/components/resource-components';
  ...
  return (
    <>
      <PageHero
        ...
        title="Where to"
        titleEm="Start"
        desc="New to CTI? This is the page. Don't overcomplicate it — start here, read everything on this page, then branch out."
      />
      <GradientRule />
      ...
      <section style={{ padding: '80px 48px', background: 'var(--cream)' }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', marginBottom: '16px' }}>
            ...
            <span style={{
              ...
              letterSpacing: '0.1em', textTransform: 'uppercase',
              padding: '3px 8px', borderRadius: '2px',
              background: 'rgba(37,99,168,0.1)', color: '#2563a8',
              border: '1px solid rgba(37,99,168,0.2)',
            }}>Beginner → Advanced</span>
          </div>
          ...
          <p style={{
            fontSize: '14px', color: 'var(--mid)', lineHeight: 1.75,
            fontWeight: 300, marginBottom: '20px',
          }}>
            The best, most comprehensive overview of Cyber Threat Intelligence in existence. From its history and
            beginnings to the philosophical discussion around attribution — this is where anyone interested in
            CTI should start to learn about the core principles of the field.
          </p>

          <JenNote>
            I'm not exaggerating when I say this is the single best resource for anyone entering CTI.
            Katie Nickels is one of the most respected practitioners in the field and this self-study plan
            reflects that. Read it. Then read it again.
          </JenNote>
        ...
        <div style={{ marginTop: '48px', maxWidth: '760px' }}>
          <SectionHeader
            number="Also worth reading"
            title="Getting Started in CTI: 4 Pieces of Advice"
          />
          <div style={{
            background: 'var(--warm-white)',
            border: '1px solid var(--border)',
            ...
            <a href="https://redcanary.com/blog/opinions-insights/getting-started-in-cyber-threat-intelligence/"
              ...
              style={{
                ...
                borderRadius: '3px', padding: '10px 20px', display: 'inline-block',
              }}>
              Read the article →
            </a>
          </div>
