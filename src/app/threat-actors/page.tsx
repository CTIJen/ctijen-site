    ...
    return (
      <>
        <PageHero
          ...
          title="Cyber Threat"
          titleEm="Actors"
          desc="Know your adversaries. Jen doesn't like to reinvent the wheel, and on this one, she doesn't have to."
        />
        <GradientRule />
          ...
          <div style={{ maxWidth: '760px' }}>
            ...
            <div style={{
              ...
              <p style={{ fontSize: '15px', color: 'var(--mid)', lineHeight: 1.8, fontWeight: 300, marginBottom: '20px' }}>
                The Electronic Transactions Development Agency out of Thailand has created what Jen considers the best
                database of cyber threat actors. It coalesces several OSINT sources you'd typically check for research
                into a single, well-maintained reference.
              </p>
              <JenNote>
                If you know me, you know I don't like to reinvent the wheel. This database does everything I'd want
                a threat actor reference to do, and it's free.
              </JenNote>
              <div style={{ marginTop: '24px' }}>
                <a href="https://apt.etda.or.th/cgi-bin/listgroups.cgi"
            ...
            <div style={{ marginTop: '40px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                {[
                  ...
                  <div key={i} style={{
                    background: 'var(--warm-white)', border: '1px solid var(--border)',
                    borderRadius: '5px', padding: '20px 24px',
                    display: 'grid', gridTemplateColumns: '200px 1fr', gap: '24px', alignItems: 'center',
                  }}>
        ...
        <ClosingNote
          text="Want to learn how to build your own threat actor profiles? Check out the Trainings page."
