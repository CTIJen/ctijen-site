    ...
    return (
      <>
        ...
        <section style={{ padding: '80px 48px', background: 'var(--cream)' }}>
          <div style={{
            background: 'var(--plum)', borderRadius: '5px', padding: '28px 32px',
            ...
            }}>Jen's take on certs</div>
            <p style={{ fontSize: '15px', color: 'rgba(250,247,242,0.7)', lineHeight: 1.8, fontWeight: 300 }}>
              Certifications are excellent at showcasing knowledge of key principles. If an employer needs to see
              real-world application, I <strong style={{ color: 'var(--cream)', fontWeight: 500 }}>highly</strong> recommend
              starting a Medium blog about CTI. Map an intrusion to the Diamond Model. Write about an APT and your
              mitigation recommendations. This shows field experience without needing an official title.
            </p>
              ...
              <div key={i} style={{
                ...
                <div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '8px', flexWrap: 'wrap' }}>
                    <a href={cert.href} target="_blank" rel="noopener noreferrer" style={{
                ...
                <div style={{ textAlign: 'right', flexShrink: 0 }}>
                  <span style={{
                    ...
                    color: 'var(--plum)', letterSpacing: '0.04em',
                  }}>{cert.cost}</span>
                </div>
              </div>
            ))}
        ...
        <ClosingNote
          text="Not sure where to start? Reach out and Jen will give you more tailored recommendations based on where you are in your journey."
