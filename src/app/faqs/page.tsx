    ...
    return (
      <>
        <PageHero
          ...
          titleEm="Questions"
          desc="The questions Jen gets asked most often, answered honestly."
        />
        <GradientRule />
                  ...
                  <div style={{ display: 'flex', gap: '8px', marginTop: '16px', flexWrap: 'wrap' }}>
                    {faq.links.map((link, j) => (
                      <a key={j} href={link.href} style={{
                        ...
                        border: '1px solid rgba(201,165,90,0.3)', borderRadius: '3px', padding: '6px 14px',
                      }}>{link.label}</a>
                    ))}
                  </div>
                )}
        ...
        <ClosingNote
          text="Have a question that's not answered here? Send it over and Jen may add it to the list."
